...
type Theme struct {
	...
	CodeComment   Style // code comments (//, #, --)
	CodeString    Style // quoted strings in code
	CodeKeyword   Style // language keywords (if, func, return, etc.)
...
var AllElementIDs = []string{
	...
	"code_comment", "code_string", "code_keyword", "code_number",
}
